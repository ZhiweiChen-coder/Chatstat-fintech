...
<template>
	<main class="mx-n3 mx-md-n4">
		<sitenav/>
		<div class="bg">
		<p class="title"><strong>Privacy Policy</strong></p>
		<p>Our Privacy Policy was last updated on [___28/08/2022___].</p>
		...
		<ul>
			...
			<li>
				<p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to [___Chatstat___]</p>
				<p>For the purpose of the GDPR, the Company is the Data Controller.</p>
			</li>
			<li>
				<p><strong>"Country"</strong> refers to [___Australia___].</p>
			</li>
			<li>
			...
			<li>
				<p><strong>"Website"</strong> refers to [___Chatstat___], accessible from [___www.chatstat.com___]</p>
			</li>
			<li>
		...
		<li>By visiting this page on our website: [___www.chatstat.com___]</li>

		<li>By sending us an email: [___info@chatstat.com___]</li>
